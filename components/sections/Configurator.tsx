...
const ITEMS: Item[] = [
  ...
  { id: "build", group: "Продажи", label: "Построение отдела", note: "Скрипты, мотивация, найм", min: 30000, max: 180000, days: [14, 30] },
  { id: "crm", group: "Продажи", label: "Внедрение CRM", note: "Воронка, интеграции, задачи", min: 30000, max: 90000, days: [5, 12] },
          ...
          <Glass strong cut="lg" className="mt-10 p-8">
            ...
            {hasCustom && chosen.length > 1 && (
              <p className="mt-5 text-[0.75rem] leading-snug text-ice-100/50">
                Чат-бот в вилку не входит — его стоимость зависит от числа
                сценариев и интеграций, посчитаю под задачу.
              </p>
            )}
